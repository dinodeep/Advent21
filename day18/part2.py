...
def main():
    ...
    snailnums = parseinput("hardinput.txt")

    pairs = [(copy.deepcopy(sn1), copy.deepcopy(sn2)) for sn1 in snailnums for sn2 in snailnums if sn1 != sn2]
    sums = [addSnailnums(sn1, sn2) for sn1, sn2 in pairs]
    magnitudes = [getMagnitude(sn) for sn in sums]
